...
document.write(`
    <p id="${id}" class="description mb-4 tm-intro-text text-justify">
        ...
        <iframe src="https://open.spotify.com/embed/episode/0gUMHR9wtVFfv7JzK4RuPz?utm_source=generator" width="100%" height="232" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
    </p>
