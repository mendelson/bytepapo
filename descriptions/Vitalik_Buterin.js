var id = 'Vitalik_Buterin';

document.write(`
    <p id="${id}" class="description mb-4 tm-intro-text text-justify">
        Neste episódio, apresentamos a história de Vitalik Buterin, programador russo-canadense que foi um dos co-fundadores da plataforma Ethereum, cuja criptomoeda é a segunda maior em termos de capitalização de mercado. Separe um byte de minutos do seu dia e venha conosco no quadro Uma Byta História!</br>
        </br>
        ...
        <iframe loading="lazy" src="https://open.spotify.com/embed/episode/6BsxTwZq8svHy7x2QZ307G" width="100%" height="232" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
    </p>
