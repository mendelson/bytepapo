...
document.write(`
    ...
    <ul id="members_${id}" class="description">
        ...
        <li>Convidado: Marcela Carvalho</li>
    ...
    <ul id="links_${id}" class="description">
        <li><a class="regular-item" href="https://www.linkedin.com/in/marcela-pcarvalho/" target="_blank">LinkedIn da Marcela Carvalho</a></li>
        <li><a class="regular-item" href="https://www.upciti.com/en/" target="_blank">Conheça a Upciti</a></li>
    </ul>
    `);
